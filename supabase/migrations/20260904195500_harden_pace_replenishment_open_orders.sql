...
-- Existing draft, ordered and partially received purchase-order lines all
-- represent an open replenishment commitment. Pace must not create a second
-- concept for the same product while any of them exists.
