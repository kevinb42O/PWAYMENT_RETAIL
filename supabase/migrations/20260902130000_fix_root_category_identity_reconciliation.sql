...
-- Keep scalar IDs separate from `%rowtype` variables. PostgreSQL applies
-- column defaults to an unassigned row variable, which made a missing parent
-- look like a random UUID instead of NULL and broke root-category matching.
