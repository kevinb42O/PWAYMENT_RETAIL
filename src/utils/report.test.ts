...
import { calculateReportData } from './report';
...
describe('calculateReportData', () => {
  it('sums totals across payment methods', () => {
    const r = calculateReportData([tx(1, 500, 'Cash'), tx(2, 750, 'PIN'), tx(3, 100, 'Cash')]);
  ...
  it('tracks cost and gross profit', () => {
    const r = calculateReportData([tx(1, 10000, 'PIN', 4500), tx(2, 5000, 'PIN', 2000)]);
