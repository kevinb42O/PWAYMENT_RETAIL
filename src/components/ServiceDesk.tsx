...
export const ServiceDesk: React.FC = () => {
  ...
  return (
    <main className="service-desk-workspace app-page-content flex-1 overflow-hidden print:overflow-visible">
