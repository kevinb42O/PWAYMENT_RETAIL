...
describe('public route metadata', () => {
  ...
  it('creates complete localized SEO tags and guide structured data', () => {
    ...
    expect(meta('meta[property="og:image:alt"]')).toBe('PWAYMENT, powered by Pace — the retail platform that works with you');
    expect(meta('meta[name="twitter:image:alt"]')).toBe('PWAYMENT, powered by Pace — the retail platform that works with you');
